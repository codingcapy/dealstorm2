...
export default function MyListPage() {
    ...
    return (
        <main className="flex-1 bg-emerald-100">
            ...
            <NavLink to="/dealstorm2/completed"
                className="flex flex-col mx-auto w-[300px] text-center px-3 py-3 my-7 rounded-3xl bg-teal-700 text-white text-2xl">Complete Grocery Run</NavLink>
        </main>
    )
}
